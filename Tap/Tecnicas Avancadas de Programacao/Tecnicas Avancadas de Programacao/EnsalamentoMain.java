public class EnsalamentoMain {
    public static void main(String [] args){
        ...
        if(e.taxaEnsalamento(t1, s2) >= 0.9){
            System.out.println("ensalamento eficiente!");
            System.out.printf("%f", e.taxaEnsalamento(t1, s2));
        }else{
            System.out.println("ensalamento nao muito eficiente...");
            System.out.printf("%f", e.taxaEnsalamento(t1, s2));
        }
    }   
}